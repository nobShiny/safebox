...
import com.lsj.safebox.adapter.FileListCursorAdapter;
import com.lsj.safebox.consts.GlobalConsts;
import com.lsj.safebox.custom.ui.CategoryBar;
import com.lsj.safebox.db.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.lsj.safebox.db.FileCategoryHelper;
import com.lsj.safebox.db.FileCategoryHelper.CategoryInfo;
import com.lsj.safebox.db.FileCategoryHelper.FileCategory;
import com.lsj.safebox.db.FileIconHelper;
import com.lsj.safebox.db.FileSortHelper;
import com.lsj.safebox.domin.FileInfo;
import com.lsj.safebox.ui.FavoriteList;
import com.lsj.safebox.ui.FileExporerTabActivity.IBackPressedListener;
import com.lsj.safebox.ui.FileViewInteractionHub.Mode;
import com.lsj.safebox.utils.Util;
import com.lsj.safebox.utils.Util.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mFileViewActivity = (FileViewActivity) ((FileExporerTabActivity) mActivity)
	...
	private void showPage(ViewPage p) {
		...
		case Home:
			...
			if (mConfigurationChanged) {
				((FileExporerTabActivity) mActivity)
