...
import com.lsj.safebox.service.FTPServerService;
...
public class ServerControlActivity extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootView = inflater.inflate(R.layout.server_control_activity,
				container, false);
		...
		instructionTextPre = (TextView) mRootView
	...
	public void updateUi() {
		...
		ImageView wifiImg = (ImageView) mRootView
		...
		TextView startStopButtonText = (TextView) mRootView
				.findViewById(R.id.start_stop_button_text);
		if (isWifiReady) {
