...
import com.lsj.safebox.db.FavoriteDatabaseHelper;
import com.lsj.safebox.db.FileOperationHelper;
import com.lsj.safebox.db.FileSortHelper;
...
import com.lsj.safebox.consts.GlobalConsts;
import com.lsj.safebox.consts.Settings;
import com.lsj.safebox.custom.ui.FileListItem.ModeCallback;
import com.lsj.safebox.custom.ui.InformationDialog;
import com.lsj.safebox.custom.ui.TextInputDialog;
import com.lsj.safebox.db.FileOperationHelper.IOperationProgressListener;
import com.lsj.safebox.db.FileSortHelper.SortMethod;
import com.lsj.safebox.ui.FileViewActivity.SelectFilesCallback;
import com.lsj.safebox.utils.IntentBuilder;
import com.lsj.safebox.utils.Util;
import com.lsj.safebox.custom.ui.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
	...
	private View.OnClickListener buttonClick = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.path_pane_up_level:
				onOperationUpLevel();
				ActionMode mode = ((FileExporerTabActivity)mContext).getActionMode();
				if (mode != null) {
					mode.finish();
				}
				break;
	...
	public void onOperationSelectAll() {
		...
		FileExporerTabActivity fileExplorerTabActivity = (FileExporerTabActivity) mContext;
	...
	private OnMenuItemClickListener menuItemClick = new OnMenuItemClickListener() {
		...
		public boolean onMenuItemClick(MenuItem item) {
			...
			case MENU_SETTING:
				...
				break;
			case MENU_EXIT:
				((FileExporerTabActivity)mContext).finish();
				break;
			// sort
			case MENU_SORT_NAME:
	...
	private com.lsj.safebox.ui.FileViewInteractionHub.Mode mCurrentMode;
	...
	private void showDropdownNavigation(boolean show) {
		...
		mNavigationBarUpDownArrow.setImageResource(mDropdownNavigation
				.getVisibility() == View.VISIBLE ? R.drawable.arrow_up:R.drawable.arrow_down);
	}
